//
//  OTSQLStatementSplitterQuotedRecogniser.m
...
@implementation OTSQLStatementSplitterQuotedRecogniser
...
{
    return [OTSQLStatementSplitterQuotedRecogniser quotedRecogniserWithStartQuote:startQuote endQuote:endQuote escapeSequence:nil name:name];
}
...
{
    return [OTSQLStatementSplitterQuotedRecogniser quotedRecogniserWithStartQuote:startQuote endQuote:endQuote escapeSequence:escapeSequence maximumLength:NSNotFound name:name];
}
...
{
    return OTSQLStatementSplitterReturnAutoreleased([[OTSQLStatementSplitterQuotedRecogniser alloc] initWithStartQuote:startQuote endQuote:endQuote escapeSequence:escapeSequence maximumLength:maximumLength name:name]);
}
...
- (NSRange)recogniseRangeWithScanner:(NSScanner *)scanner currentTokenPosition:(NSUInteger *)tokenPosition
{
    ...
    NSUInteger rangeLength = [OTSQLStatementSplitterQuotedRecogniser minWithLeftParam:inputLength - *tokenPosition
