//
//  OTSQLStatementSplitterKeywordRecogniser.m
...
@implementation OTSQLStatementSplitterKeywordRecogniser
...
{
    return OTSQLStatementSplitterReturnAutoreleased([[self alloc] initWithKeywords:keywords]);
}
...
{
    return OTSQLStatementSplitterReturnAutoreleased([[self alloc] initWithKeywords:keywords invalidFollowingCharacters:invalidFollowingCharacters]);
}
